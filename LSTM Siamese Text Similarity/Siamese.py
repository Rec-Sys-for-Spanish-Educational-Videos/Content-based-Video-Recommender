# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 13:45:52 2019
...
for i in range (0,3):
    for j in range (i,3):
        test_sentence_pairs = [(getEnglishTranscriptForId(sortedScores[i][0]),getEnglishTranscriptForId(sortedScores[j][0]))]
        #test_sentence_pairs = [('I am Jeff','My name Jeff')]
